function calculaIMC(){
	...
	var peso = parseFloat(document.getElementById("peso").value);       //conversão do número digitado para valor flutuante.
	var altura = parseFloat(document.getElementById("altura").value);   //conversão do número digitado para valor flutuante.
